...
using I2CTCA9546RegisterOnBoard GENPYBIND(visible) =
...
using I2CAD5252RwRegisterOnAD5252Channel GENPYBIND(visible) =
    halco::hicann_dls::vx::I2CAD5252RwRegisterOnAD5252Channel;
