...
class Test_PyhalcoHICANNDLSvx(unittest.TestCase, PyhalcoTest):
    ...
    SystimeCorrectionBarrierConfigOnFPGA => linear,iterable
    ...
    ExternalPPUDRAMMemoryByteOnFPGA => ignore
    ExternalPPUDRAMMemoryQuadOnFPGA => ignore
    ExternalPPUDRAMMemoryBlockSize => ignore
    ExternalPPUDRAMMemoryBlockOnFPGA => ignore
    ExternalPPUDRAMMemoryOnFPGA => iterable
    ...
    CapMemSRAMTimingConfigOnDLS => linear,iterable
    ...
    EventSwitchReadoutOnFPGA => linear,iterable
    EventSwitchConfigOnFPGA => linear,iterable
    ExtollAddress => linear
    ExtollChipType => linear,iterable
    ExtollNodeId => linear
    ExtollNodeIdOnExtollNetwork => linear
    ExtollAddressOnExtollNetwork => linear
    ExtollBarrierTriggerReachedOnExtollNodeId => linear,iterable
    ExtollBarrierTriggerReachedOnExtollNetwork => linear,iterable
    ExtollBarrierReleasedOnExtollNodeId => linear,iterable
    ExtollBarrierReleasedOnExtollNetwork => linear,iterable
    LinkOnExtollNode => linear,iterable
    ExtollBarrierConfigOnExtollNodeId => linear,iterable
    ExtollBarrierConfigOnExtollNetwork => linear,iterable
    ExtollInterruptControlOnExtollNodeId => linear,iterable
    ExtollInterruptControlOnExtollNetwork => linear,iterable
    ExtollInterruptConfigOnExtollNodeId => linear,iterable
    ExtollInterruptConfigOnExtollNetwork => linear,iterable
    ExtollBarrierInterruptInportErrorCountOnFPGA => linear,iterable
    ExtollBarrierInterruptInportCounterResetOnFPGA => linear,iterable
    ...
    ExtollSpikeCommRouterEventLossDisabledOnSpikeCommSplit => linear,iterable
    ExtollSpikeCommRouterEventLossDisabledOnFPGA => linear,iterable
    ExtollSpikeCommRouterEventLossMisconfOnSpikeCommSplit => linear,iterable
    ExtollSpikeCommRouterEventLossMisconfOnFPGA => linear,iterable
    ExtollSpikeCommRouterEventsRoutedOnSpikeCommSplit => linear,iterable
    ExtollSpikeCommRouterEventsRoutedOnFPGA => linear,iterable
    ExtollSpikeCommRouterCounterResetOnSpikeCommSplit => linear,iterable
    ExtollSpikeCommRouterCounterResetOnFPGA => linear,iterable
    ExtollSpikeCommDecoderNumEventsReceivedOnSpikeCommSplit => linear,iterable
    ExtollSpikeCommDecoderNumEventsReceivedOnFPGA => linear,iterable
    ExtollSpikeCommDecoderCounterResetOnFPGA => linear,iterable
    ExtollSpikeCommTimestampDelayConfigOnSpikeCommSplit => linear,iterable
    ExtollSpikeCommTimestampDelayConfigOnFPGA => linear,iterable
    ExtollSpikeCommTimestampDelayNumEventsReceivedOnSpikeCommSplit => linear,iterable
    ExtollSpikeCommTimestampDelayNumEventsReceivedOnFPGA => linear,iterable
    ExtollSpikeCommTimestampDelayEventLossFullOnSpikeCommSplit => linear,iterable
    ExtollSpikeCommTimestampDelayEventLossFullOnFPGA => linear,iterable
    ExtollSpikeCommTimestampDelayEventLossExpiredOnSpikeCommSplit => linear,iterable
    ExtollSpikeCommTimestampDelayEventLossExpiredOnFPGA => linear,iterable
    ExtollSpikeCommTimestampDelayCounterResetOnSpikeCommSplit => linear,iterable
    ExtollSpikeCommTimestampDelayCounterResetOnFPGA => linear,iterable
    ...
    @staticmethod
    def get_module():
        import pyhalco_hicann_dls_vx_v3
        return pyhalco_hicann_dls_vx_v3
